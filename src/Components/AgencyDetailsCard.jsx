                ...
                <div className="shadow p-4 rounded-lg bg-white">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="mt-2 text-sm text-gray-800 line-clamp-1">
                            NDRF Headquarters, New Delhi, India
                        </p>
                        <p className="mt-2 text-sm text-gray-800 line-clamp-1 flex gap-10" >
                    ...
                    <div className="grid grid-cols-2 grid-rows-1 gap-4 mt-4">
                        <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                            ...
                            <span className="mt-2 xl:mt-0">
                                Government Disaster Response Agency
                            </span>
                        </p>
                        <p className="inline-flex flex-col xl:flex-row xl:items-center text-gray-800">
                    ...
                    <div className="grid grid-cols-2 grid-rows-1 gap-4 mt-4">
                        <p className="flex flex-col text-gray-800">
                            <span className="mt-2 xl:mt-0 font-semibold">
                    ...
                    <div className='m-5 '>
                        ...
                        <div className='mt-1'>
                            Lorem, ipsum dolor sit amet consectetur adipisicing elit. Enim dolores exercitationem optio assumenda nemo, quidem, nihil qui ex aut incidunt adipisci similique rem voluptas nulla quibusdam libero officia eaque doloremque.
                        </div>
                    </div>
                </div>
            </div>
